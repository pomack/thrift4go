...
func NewTNonblockingServer2(processor base.TProcessor, 
                       serverTransport transport.TServerTransport,
                      ) *TNonblockingServer {
  return NewTNonblockingServerFactory2(base.NewTProcessorFactory(processor), serverTransport);
}

func NewTNonblockingServer4(processor base.TProcessor, 
                       serverTransport transport.TServerTransport, 
...
func NewTNonblockingServer6(processor base.TProcessor, 
                       serverTransport transport.TServerTransport,
                       inputTransportFactory transport.TTransportFactory,
                       outputTransportFactory transport.TTransportFactory,
                       inputProtocolFactory protocol.TProtocolFactory,
...
func NewTNonblockingServerFactory2(processorFactory base.TProcessorFactory,
                              serverTransport transport.TServerTransport,
                              ) *TNonblockingServer {
...
func NewTNonblockingServerFactory4(processorFactory base.TProcessorFactory, 
                              serverTransport transport.TServerTransport, 
                              transportFactory transport.TTransportFactory, 
                              protocolFactory protocol.TProtocolFactory,
                             ) *TNonblockingServer {
...
func NewTNonblockingServerFactory6(processorFactory base.TProcessorFactory, 
                              serverTransport transport.TServerTransport,
                              inputTransportFactory transport.TTransportFactory,
                              outputTransportFactory transport.TTransportFactory,
                              inputProtocolFactory protocol.TProtocolFactory,
